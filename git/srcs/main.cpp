...
/*   Updated: 2021/09/21 15:26:24 by eyohn            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//	10. добавить обработку сиджи переданного в качестве аргумента				- and here
//		1 + get file_name
...
//		3 + execute CGI file
//		4 + exit server
//		5 correct execute engine for websockets
//	11. проверить сервер на утечку дескрипторов
//	13. добавить отправку закрытия соединения
//	14. нужен ли нам цикл чтения большого количества запросов что бы попорядку потом на них отвечать
