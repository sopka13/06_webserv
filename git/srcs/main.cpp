...
/*   Updated: 2021/09/26 10:32:12 by eyohn            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//	7. добавить обработку переменных из тела запроса при приеме POST метода		- I'm here (Sergey)
//		1 get body
...
//	16. добавить механизм отправки нужного кода ошибки							- and here (Sergey)
//			1 + add new class
//			2 rewrite handler fd with new class
//	19. реализовать проверку версии http
//	20. избавиться от состояния EPOLLOUT										- and here (Sergey)
