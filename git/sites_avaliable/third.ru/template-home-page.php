						...
						<div class="contact-form col-md-7 col-md-offset-1 clearfix">
							...
							<form id="contact-form" class="contact-form clearfix">
								...
								<fieldset class="captcha col-sm-6">
									<input type="text" id="contact-form-captcha" name="captcha" placeholder="<?php echo $a . ' + ' . $b . ' = ?'; ?>" class="required cf-form-control" data-rule-equalto="#captcha-value" data-msg-equalto="<?php echo $equalto; ?>" />
