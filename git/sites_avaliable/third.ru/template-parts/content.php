...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<div class="entry-content">
		...
		<div class="entry-publish-date">
			<span class="post-date-day"><?php echo esc_html( date( 'd', strtotime( get_the_date() ) ) ); ?></span>
			<span class="post-date-month"><?php echo esc_html( date( 'M', strtotime( get_the_date() ) ) ); ?></span>
